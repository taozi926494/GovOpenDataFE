<template>
    <div class="meta-item">
        ...
        <div class="meta-item-value">{{ data.download_num }}</div>
    </div>
...
<style lang="scss">
$table-boder: 1px solid #a6caf3;
.meta-item{
    width: 100%;
    @include flex(row);
    border-top: $table-boder;
    border-bottom: $table-boder;
    border-left: $table-boder;
    &-title, &-value{
        width: 100%;
        flex: 1;
        height: 40px;
